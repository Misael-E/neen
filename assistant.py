...
sys_msg = (
	...
	'Use all of the context of this converation so your response is relevant to the conversation. Make '
...
def function_call(prompt):
	sys_msg = (
		...
		'Do not respond with anything but the most logical selction from that list with no explanations. Format the '
		'function call name exactly I listed.'
	)
